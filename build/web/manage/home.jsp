<%-- 
    Document   : home
    Created on : Mar 9, 2024, 1:57:07 AM
    Author     : Admin
--%>
			...
			<div class="container">
				<div class="row small-gutters">
					<div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
						<div id="logo">
							<a href="index-2.html"><img src="img/logo.svg" alt="" width="100" height="35"></a>
						</div>
					</div>
							...
							<ul>
								<li class="submenu">
									...
									<ul>
										...
										<li><a href="index-5.html">GDPR Cookie Bar</a></li>
									</ul>
								</li>
								<li class="megamenu submenu">
									<a href="#0" class="show-submenu-mega">Pages</a>
